---
layout: post
title:  数据结构-集合定义、操作和属性
tags: [数据结构]
---

**【内容】**集合是一种包含不同元素的数据结构。集合中每个元素只出现一次，不同于字典和链表。集合中元素是无序的，同时是不互相同的。

- 1.并集：将两个集合中的成员进行合并，得到一个新的集合；
- 2.交集：将两个集合中共同存在的成员组成的一个新的集合；
- 3.补集：属于一个集合而不属于另一个集合的成员组成的新的集合；
 ...
 * @Last Modified time: 2018-04-08 14:43:25
 */
